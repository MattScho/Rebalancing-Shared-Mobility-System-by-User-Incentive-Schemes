...
class BSS_Controller_Rep1(gym.Env):
    '''
    ...
    def __init__(self, bss_inits, budget, stepFile):
        """
        ...
        self.systemSize = bss_inits.getSystemSize()

        # Number of steps per episode
        self.steps = bss_inits.getStepsPerEpisode()
